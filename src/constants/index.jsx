...
export const plans = [
  {
    ...
    features: [
      ...
      "مرافقة في رحلات الحدث (بدون رسوم لأعضاء المجتمع، 35,000 دج للآخرين)",
      "اشتراك 6 أشهر في منتجات واب سكايل مع تخفيضات على كلا العرضين",
      // "مشاهدة البودكاست",
  ...
  },
  {
    ...
    features: [
      ...
      "إمكانية طرح الأسئلة أثناء اللقاءات الأسبوعية",
      "مرافقة في رحلات الحدث (بدون رسوم لأعضاء المجتمع، 35,000 دج للآخرين)",
      "اشتراك سنة في منتجات واب سكايل مع تخفيضات على كلا العرضين",
      // "مشاهدة البودكاست",
      // "التسجيل في قائمة انتظار WebCEO",
    ],
