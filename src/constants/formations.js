...
export const formations = {
  ...
  promotionDays: {
    ...
    solutions: [
      "تحديد هوية المشروع وطريقة التواصل الخاصة به مع السوق",
      "بناء شخصية العميل (Buyer Persona) انطلاقًا من البيانات",
      "استخدام نموذج SOSTAC لبناء خطة تسويق متكاملة ومنهجية",
      "حساب الميزانية التسويقية وتوزيعها بشكل ذكي",
      "فهم مؤشرات الأداء المالية (CAC, LTV) واستخدامها في اتخاذ القرار",
      "اختيار القنوات التسويقية المناسبة بدل التواجد في كل مكان دون نتائج",
      "بناء فريق تسويق فعّال وتحديد الأدوار والمسؤوليات بوضوح",
      "استخدام أنظمة CRM في تحسين الترويج وإدارة العلاقة مع العملاء",
    ],
    benefits: [
